...
const EditUserSidebar = ({ 
  ...
  return (
    <div
      className={`z-50 fixed inset-y-0 right-0 w-[529px] h-[875px] p-[30px] bg-white rounded-tl-[12px] rounded-bl-[12px] shadow-[0px_6px_58px_0px_rgba(121,145,173,0.20)] transform transition-transform duration-300 ease-in-out ${isEditUserOpen ? 'translate-x-0' : 'translate-x-full'}`}
    >
...
{/* 
        ...
        <form className="space-y-[20px] flex flex-col align-bottom mt-[19px]" onSubmit={handleEditUser}>
          ...
          <div>
            ...
            <input
              ...
              readOnly  
              className="bg-[#d3d3d3] opacity-50 mt-[9px] w-full h-11 pl-[15px] pr-[13px] py-5 rounded-lg border border-[#cbcad7] 
